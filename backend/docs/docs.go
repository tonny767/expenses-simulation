...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "API Support",
            "email": "tonny.wijayajuly2001@gmail.com"
        },
        "license": {
            "name": "MIT",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/actions.SubmitExpenseInput"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/controllers.ExpensesListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/controllers.StatusExpenseRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "controllers.ExpensesListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
        ...
        "controllers.LoginResponse": {
            ...
            "properties": {
                ...
                "role": {
                    ...
                    "example": "constants.UserRoleUser"
                },
                "token": {
                    "type": "string",
        ...
        "controllers.StatusExpenseRequest": {
            "type": "object",
            "properties": {
                "approver_id": {
                    "type": "integer",
